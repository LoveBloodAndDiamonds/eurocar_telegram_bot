...
async def faq_callback_handler(callback_query: types.CallbackQuery, callback_data: FaqCallback) -> types.Message:
    ...
    if callback_data.answer == 'back':
        ...
        with open(f"templates/faq/{callback_data.answer}.txt", "r") as file:
